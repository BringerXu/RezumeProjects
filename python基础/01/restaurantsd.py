...
def handle_commands(C: list) -> list:
    ...
    while True:
        ...
        if response=="q":
            ...
            n = int(input('Please enter the percentage you want to change:  '))
...
def Restaurant_change_price(r,n):
        return r._replace(price=r.price*(1+(n/100)))

def Collection_change_prices(C:list,n:int):
	New=[]
	for r in C:
		New.append(Restaurant_change_price(r,n))
	return New
restaurants()
